...
public class ActiveDirectoryNew {
    ...
    private static InitialLdapContext context;
    private ActiveDirectoryNew(){}
    ...
    public static LdapContext getConnection(String username, String password, String domainName, String serverName) throws NamingException {
        ...
        try{
            ActiveDirectoryNew.context = new InitialLdapContext(props, null);
            return ActiveDirectoryNew.context;
        }
